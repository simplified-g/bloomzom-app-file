...
class ProService extends StatefulWidget {
  @override
  _ProServiceState createState() => _ProServiceState();
}

class _ProServiceState extends State<ProService> {
  @override
        ...
        Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('images/prof_service_bg.jpg'),
                    fit: BoxFit.cover))),
        Container(
            height: 200,
            width: MediaQuery.of(context).size.width,
