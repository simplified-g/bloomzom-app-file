...
class LoginVerify extends StatefulWidget {
  ...
  const LoginVerify({Key key, this.category}) : super(key: key);
  @override
...
class _LoginVerifyState extends State<LoginVerify> {
  ...
  _decipherLogic() {
    if (widget.category.toLowerCase() == 'buyers') {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ManufacturerDashBoard()),
      );
    } else if (widget.category.toLowerCase() == 'delivery merchant') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => DeliveryDashboardPage()),
      );
    } else if (widget.category.toLowerCase() == 'fast food/groceries vendor') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => GroceriesDashboardPage()),
      );
