...
class ReplyCase extends StatefulWidget {
  @override
  _ReplyCaseState createState() => _ReplyCaseState();
}

class _ReplyCaseState extends State<ReplyCase> {
